...
<body>
    <div class="container3">
        ...
        <div class="buttons">
            <button class="btn regresar-btn" onclick="window.location.href='gestion_menus2.php';">Regresar</button>
        </div>
                ...
                <tbody>
                    ...
                    if ($result_menu && mysqli_num_rows($result_menu) > 0) {
                        while ($row_menu = mysqli_fetch_assoc($result_menu)) {
                            ...
                            echo "<td>
                                    <button class='action-btn' onclick=\"window.location.href='modificarmenu2.php?id={$row_menu['id_menu']}';\">
