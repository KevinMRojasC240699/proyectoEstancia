...
<head>
    ...
    <title>Reportes para Administrador</title>
    ...
    <div class="reportes-outer-container">
        ...
        <div class="reportes-container1">
            <header class="reportes-header">
                ...
                <h1 class="reportes-h1">Reportes para Administrador</h1>
            </header>
            <main class="reportes-main">
                <div class="reportes-container2">
                    <h3 class="reportes-h2">Número de Pacientes</h3>
                    <button class="reportes-btn" onclick="window.location.href='fechaReportesAdmin.php';">Generar</button>
                    ...
                    <h3 class="reportes-h2">Número de Nutriólogos</h3>
                    <button class="reportes-btn" onclick="window.location.href='reportesNutriologo.php';">Generar</button>
                    <br>
                    <br>
                    <button class="reportes-regresar-btn"onclick="window.location.href='admin.php';">Regresar</button>
                </div>
