...
<body>
    <div class="container3">
        ...
        <div class="buttons">
            <button class="btn" onclick="window.location.href='registerPla.php';">Registrar Platillo</button>
    ...
    <script>
        ...
        function buscarNutriologo(event) {
            ...
            fetch(`busquedaPla.php?search=${search}`)
                .then(response => response.text())
                .then(data => {
                    document.querySelector('#platillos-tbody').innerHTML = data;
                })
