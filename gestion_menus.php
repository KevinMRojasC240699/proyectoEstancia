...
<body>
    <div class="container3">
        ...
        <div class="buttons">
        <button class="btn" onclick="window.location.href='gestionmenu.php';">Gestionar Menús</button> 
        ...
        <div class="form-container">
            <form id="menu-form" action="guardar_menu.php" method="POST">
